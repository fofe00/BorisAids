...
<head>
    ...
    <title>BorisAids|Home</title>
    <meta name="author" content="ainix-dev,devWus,lonfo fofe blondeau">
    <meta name="description" content="boris aids applicqtion">
    <meta name="keywords" content="fofe ,borisAids,borisaids,fofe ,lonfo">

<!--    <link rel="stylesheet" href="{{ asset('css/font.css') }}">-->
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css">

    <link href="{{ asset('css/app.css') }}" rel="stylesheet"> <!--Replace with your tailwind.css once created-->
    <link href="{{ asset('css/emoji.css') }}" rel="stylesheet"> <!--Totally optional :) -->
...
<nav class="bg-gray-800 pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
    ...
    <div class="flex flex-wrap items-center">
        <div class="flex flex-shrink md:w-1/3 justify-center md:justify-start text-white">
            <a href="#">
                <span class="text-xl pl-2"><i class="em em-grinning"></i></span></a>
        </div>
...
<div class="flex flex-col md:flex-row">
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 pt-3 ">
            <div class="rounded-t-lg  border-t-4 border-red-100   p-4 shadow text-2xl text-white">
